...
namespace AstriaPorta.Content
{
    public abstract partial class BEStargate
	{
		...
		/// <summary>
		/// Initializes and registers the gate main renderer. Should also call the event
		/// horizon renderer initializer
		/// </summary>
		/// <remarks>
		/// client side
		/// </remarks>
		/// <param name="api"></param>
		protected abstract void InitializeRenderer(ICoreAPI api);
